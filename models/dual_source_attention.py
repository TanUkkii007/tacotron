...
class DualSourceAttentionWrapper(rnn_cell_impl.RNNCell):
    ...
    def __init__(self,
        ...
        if attention_layer_size is not None:
            ...
            _attention_size1 = attention_mechanism1.values.get_shape()[-1].value
            _attention_size2 = attention_mechanism2.values.get_shape()[-1].value
            self._attention_size = _attention_size1 + _attention_size2
    ...
    def call(self, inputs, state):
        ...
        with ops.control_dependencies([
            ...
            if self._attention_layer is not None:
                ...
                attention = array_ops.concat([context1, context2], axis=1)
